...
public:
	...
	void SaveSpecificPreset( UConsoleVariablesAsset* Preset) const;
	void SavePresetAs() const;
	void SaveSpecificPresetAs( UConsoleVariablesAsset* Preset) const;
	void OpenConsoleVariablesDialogWithPreset( UConsoleVariablesAsset* Preset) const;
	...
	[[nodiscard]] UConsoleVariablesAsset* GetPresetAsset() const;
	[[nodiscard]] UConsoleVariablesAsset* GetGlobalSearchAsset() const;
	...
	void UpdatePresetValuesForSave(UConsoleVariablesAsset* InAsset);
...
private:
	...
	UConsoleVariablesAsset* AllocateTransientPreset(const FName DesiredName) const;
	...
	UConsoleVariablesAsset* EditingPresetAsset = nullptr;
	/** Transient preset that tracks variables that match the search criteria */
	UConsoleVariablesAsset* EditingGlobalSearchAsset = nullptr;
