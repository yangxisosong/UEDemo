...
{
	const FConsoleVariablesEditorModule& ConsoleVariablesEditorModule = FConsoleVariablesEditorModule::Get();
	const FReply Reply = ConsoleVariablesEditorModule.ValidateConsoleInputAndAddToCurrentPreset(FText::FromString(NewCommand));
	if (
	...
	const FString InValue)
{
	...
	const TWeakPtr<FConsoleVariablesEditorCommandInfo> CommandInfo =
		ConsoleVariablesEditorModule.FindCommandInfoByName(InCommandName); 
