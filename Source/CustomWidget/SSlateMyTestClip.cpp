	...
	bool bParentEnabled) const
{
	...
	//vertexs[0] = FSlateVertex::Make<ESlateVertexRounding::Disabled>(pRenderTransform, TopLeft, LocalSize, DrawScale, FColor::Red);
	//vertexs[1] = FSlateVertex::Make<ESlateVertexRounding::Disabled>(pRenderTransform, BotLeft, LocalSize, DrawScale, FColor::Green);
	//vertexs[2] = FSlateVertex::Make<ESlateVertexRounding::Disabled>(pRenderTransform, BotRight, LocalSize, DrawScale, FColor::Blue);
