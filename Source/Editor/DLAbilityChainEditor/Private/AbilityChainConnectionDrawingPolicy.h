...
class FAbilityChainConnectionDrawingPolicy : public FConnectionDrawingPolicy
{
protected:
	UEdGraph* GraphObj;
...
public:
	FAbilityChainConnectionDrawingPolicy(int32 InBackLayerID, int32 InFrontLayerID,
