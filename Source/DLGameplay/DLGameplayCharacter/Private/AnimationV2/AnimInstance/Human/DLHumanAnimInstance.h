...
#include "DLHumanAnimInstance.generated.h"

/**
 * 人形角色动画实例
 */
UCLASS()
class DLGAMEPLAYCHARACTER_API UDLHumanAnimInstance : public UDLMainAnimInstanceV2
{
	GENERATED_BODY()
...
protected:
	...
	{
		AnimConfig = *(static_cast<const FHumanAnimConfig*> (InAnimConfig));
	};
	...
	virtual FString GetLogCategory_Implementation() override { return "UDLHumanAnimInstance"; }
